    ...
    return (
       <div className="text-white  w-full flex flex-col px-40 py-5 gap-4 h-fit">
        ...
        <div className="flex gap-4 h-full rounded-lg py-1 px-2 flex-wrap">
          ...
          about=" CLS measures the visual stability of a webpage. It quantifies the amount of unexpected layout shifts that occur during the entire lifespan of a page. An unexpected layout shift happens when a visible element on the page changes its position (e.g., text moving down, a button appearing and pushing content) without being directly triggered by a user interaction." goodScore="≤ 0.1"></ScoreCard>
...
.category}
about="LCP measures loading performance. It reports the render time of the largest image or text block visible within the user's viewport . Essentially, it tells you how long it takes for the main content of your page to become visible to the user" goodScore="Good: ≤ 2.5 seconds
"></ScoreCard>
