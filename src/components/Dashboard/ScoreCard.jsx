function ScoreCard({category, scoreData, about, goodScore}) {
 if (!scoreData) {
    ...
    return (
        <div className="w-full h-full min-h-70 max-w-140 min-w-100 px-5 py-3 text-white flex flex-col gap-3 border-2 border-green-600/30 rounded-lg font-grotesk justify-center ">
