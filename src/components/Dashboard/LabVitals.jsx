    ...
    return (
       <div className="text-white  w-fit flex flex-col justify-center items-center py-5 h-fit flex-wrap font-grotesk">
        ...
        <div className="flex sm:gap-6 md:gap-8 h-full flex-wrap justify-center items-center">
          ...
          about="The time from the initial request of a page until the first byte of the response is received by the browser. It includes DNS lookup, TCP connection, TLS negotiation, and the server's processing time to generate and send the response." goodScore="≤ 200 milliseconds"></ScoreCard>
